...
export const SCRIPT_VARIANT_BOOTSTRAP = `(function(){try{var k=${JSON.stringify(
  SCRIPT_VARIANT_STORAGE_KEY,
)};var v=localStorage.getItem(k);if(!v){var p=k+"=";var c=document.cookie.split("; ");for(var i=0;i<c.length;i++){if(c[i].indexOf(p)===0){v=decodeURIComponent(c[i].slice(p.length));break;}}}var t=v==="simplified"||v==="traditional"?v:${JSON.stringify(
  DEFAULT_SCRIPT_VARIANT,
)};var e=document.documentElement;e.dataset.scriptVariant=t;e.lang=t==="traditional"?"zh-Hant":"zh-CN";}catch(_){}})();`;
